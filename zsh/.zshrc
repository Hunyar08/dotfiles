...
export PATH=$PATH:/home/hun/.spicetify

# history saving
export HISTFILE="$HOME/.zsh_history"
export HISTSIZE=10000000
export SAVEHIST=10000000
setopt INC_APPEND_HISTORY_TIME # Write to history file immediately after execution with timestamps
setopt SHARE_HISTORY          # Share history across all open terminal sessions immediately
setopt HIST_IGNORE_ALL_DUPS   # If a new command is a duplicate, remove the older one
setopt HIST_REDUCE_BLANKS     # Remove superfluous blanks from each command line

# cycle thru commands that were saved
